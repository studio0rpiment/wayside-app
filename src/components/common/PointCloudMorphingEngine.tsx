...
const PointCloudMorphingEngine: React.FC<PointCloudMorphingEngineProps> = ({
  ...
  const createMorphingPointCloud = () => {
    ...
    morphingGroup.scale.set(crossExperienceScale, crossExperienceScale, crossExperienceScale);
    console.log(`🎯 ${modelPrefix} cross-experience scale: ${crossExperienceScale.toFixed(3)}`);
